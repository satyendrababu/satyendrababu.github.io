...
import 'package:simple_ehr/data/remote/dio/logging_interceptor.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton(() => DioClient('baseUrl', sl(), loggingInterceptor: sl(), sharedPreferences: sl()));
